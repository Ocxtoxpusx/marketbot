...
### Файл для работы с базой данных SQLite на основе ORM SQLAlchemy и служебными функциями
...
def get_category_name(id: int, position_type: str) -> String:
    name = ''
...
### Служебные функции для работы бота и базы данных
